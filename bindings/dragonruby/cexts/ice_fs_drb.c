...
static ice_fs_dir drb_ffi__ZTS10ice_fs_dir_FromRuby(mrb_state *state, mrb_value self) {
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_DIR");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTS10ice_fs_dir);
...
static mrb_value drb_ffi__ZTS10ice_fs_dir_ToRuby(mrb_state *state, ice_fs_dir value) {
    ...
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_DIR");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTS10ice_fs_dir);
    return mrb_obj_value(rdata);
}
...
static ice_fs_dir *drb_ffi__ZTSP10ice_fs_dir_FromRuby(mrb_state *state, mrb_value self) {
    ...
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_DIR_PTR");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTSP10ice_fs_dir);
...
static mrb_value drb_ffi__ZTSP10ice_fs_dir_ToRuby(mrb_state *state, ice_fs_dir *value) {
    ...
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_DIR_PTR");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTSP10ice_fs_dir);
    return mrb_obj_value(rdata);
}
...
static ice_fs_date *drb_ffi__ZTSP11ice_fs_date_FromRuby(mrb_state *state, mrb_value self) {
    ...
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_DATE_PTR");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTSP11ice_fs_date);
...
static mrb_value drb_ffi__ZTSP11ice_fs_date_ToRuby(mrb_state *state, ice_fs_date *value) {
    ...
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_DATE_PTR");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTSP11ice_fs_date);
    return mrb_obj_value(rdata);
}
...
static ice_fs_object *drb_ffi__ZTSP13ice_fs_object_FromRuby(mrb_state *state, mrb_value self) {
    ...
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_OBJECT_PTR");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTSP13ice_fs_object);
...
static mrb_value drb_ffi__ZTSP13ice_fs_object_ToRuby(mrb_state *state, ice_fs_object *value) {
    ...
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_OBJECT_PTR");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTSP13ice_fs_object);
    return mrb_obj_value(rdata);
}
...
static ice_fs_date drb_ffi__ZTS11ice_fs_date_FromRuby(mrb_state *state, mrb_value self) {
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_DATE");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTS11ice_fs_date);
...
static mrb_value drb_ffi__ZTS11ice_fs_date_ToRuby(mrb_state *state, ice_fs_date value) {
    ...
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_DATE");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTS11ice_fs_date);
    return mrb_obj_value(rdata);
}
...
static ice_fs_object drb_ffi__ZTS13ice_fs_object_FromRuby(mrb_state *state, mrb_value self) {
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_OBJECT");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTS13ice_fs_object);
...
static mrb_value drb_ffi__ZTS13ice_fs_object_ToRuby(mrb_state *state, ice_fs_object value) {
    ...
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "ICE_FS_OBJECT");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTS13ice_fs_object);
    return mrb_obj_value(rdata);
}
...
static mrb_value drb_ffi__ZTSP10ice_fs_dir_New(mrb_state *mrb, mrb_value self) {
    ...
    struct RClass *FFI = drb_api->mrb_module_get(mrb, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(mrb, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(mrb, module, "ICE_FS_DIR_PTR");
    struct RData *rdata = drb_api->mrb_data_object_alloc(mrb, klass, ptr, &ForeignObjectType_ZTSP10ice_fs_dir);
    return mrb_obj_value(rdata);
}
...
static mrb_value drb_ffi__ZTSP11ice_fs_date_New(mrb_state *mrb, mrb_value self) {
    ...
    struct RClass *FFI = drb_api->mrb_module_get(mrb, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(mrb, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(mrb, module, "ICE_FS_DATE_PTR");
    struct RData *rdata = drb_api->mrb_data_object_alloc(mrb, klass, ptr, &ForeignObjectType_ZTSP11ice_fs_date);
    return mrb_obj_value(rdata);
}
...
static mrb_value drb_ffi__ZTSP13ice_fs_object_New(mrb_state *mrb, mrb_value self) {
    ...
    struct RClass *FFI = drb_api->mrb_module_get(mrb, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(mrb, FFI, "CExt");
    struct RClass *klass = drb_api->mrb_class_get_under(mrb, module, "ICE_FS_OBJECT_PTR");
    struct RData *rdata = drb_api->mrb_data_object_alloc(mrb, klass, ptr, &ForeignObjectType_ZTSP13ice_fs_object);
    return mrb_obj_value(rdata);
}
...
static mrb_value drb_ffi_ice_fs_str_len_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_len': wrong number of arguments (%d for 1)", argc);
...
static mrb_value drb_ffi_ice_fs_str_starts_with_slash_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_starts_with_slash': wrong number of arguments (%d for 1)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_str_ends_with_slash_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_ends_with_slash': wrong number of arguments (%d for 1)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_str_slashes_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_slashes': wrong number of arguments (%d for 1)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_str_dots_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_dots': wrong number of arguments (%d for 1)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_str_same_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_same': wrong number of arguments (%d for 2)", argc);
...
static mrb_value drb_ffi_ice_fs_str_char_to_str_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_char_to_str': wrong number of arguments (%d for 1)", argc);
    char ch_0 = drb_ffi__ZTSc_FromRuby(state, args[0]);
    char *ret_val = ice_fs_str_char_to_str(ch_0);
...
static mrb_value drb_ffi_ice_fs_str_sub_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_sub': wrong number of arguments (%d for 3)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_str_copy_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_copy': wrong number of arguments (%d for 1)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_str_split_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_split': wrong number of arguments (%d for 3)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_str_splitlines_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_splitlines': wrong number of arguments (%d for 2)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_str_matches_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_str_matches': wrong number of arguments (%d for 3)", argc);
    char *str1_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
    char *str2_1 = drb_ffi__ZTSPc_FromRuby(state, args[1]);
...
static mrb_value drb_ffi_ice_fs_free_str_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_free_str': wrong number of arguments (%d for 1)", argc);
    char *str_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_free_strarr_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_free_strarr': wrong number of arguments (%d for 2)", argc);
...
static mrb_value drb_ffi_ice_fs_root_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_root': wrong number of arguments (%d for 1)", argc);
...
static mrb_value drb_ffi_ice_fs_is_root_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_is_root': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_concat_path_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_concat_path': wrong number of arguments (%d for 2)", argc);
...
static mrb_value drb_ffi_ice_fs_filename_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_filename': wrong number of arguments (%d for 2)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_ext_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_ext': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_is_ext_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_is_ext': wrong number of arguments (%d for 2)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_prev_path_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_prev_path': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_path_parents_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_path_parents': wrong number of arguments (%d for 2)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_path_exists_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_path_exists': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_cwd_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 0)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_cwd': wrong number of arguments (%d for 0)", argc);
...
static mrb_value drb_ffi_ice_fs_home_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 0)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_home': wrong number of arguments (%d for 0)", argc);
...
static mrb_value drb_ffi_ice_fs_format_path_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_format_path': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_fullpath_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_fullpath': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_link_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_link': wrong number of arguments (%d for 3)", argc);
    char *path1_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
    char *path2_1 = drb_ffi__ZTSPc_FromRuby(state, args[1]);
...
static mrb_value drb_ffi_ice_fs_readlink_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_readlink': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_type_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_type': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_file_content_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_file_content': wrong number of arguments (%d for 2)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_file_write_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_file_write': wrong number of arguments (%d for 3)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_file_lines_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_file_lines': wrong number of arguments (%d for 2)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_chdir_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_chdir': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_dir_content_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_dir_content': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_free_dir_content_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_free_dir_content': wrong number of arguments (%d for 1)", argc);
...
static mrb_value drb_ffi_ice_fs_dir_search_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_dir_search': wrong number of arguments (%d for 3)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_create_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_create': wrong number of arguments (%d for 2)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_remove_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_remove': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_clear_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_clear': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_copy_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_copy': wrong number of arguments (%d for 2)", argc);
    char *path1_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
    char *path2_1 = drb_ffi__ZTSPc_FromRuby(state, args[1]);
...
static mrb_value drb_ffi_ice_fs_move_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_move': wrong number of arguments (%d for 2)", argc);
    char *path1_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
    char *path2_1 = drb_ffi__ZTSPc_FromRuby(state, args[1]);
...
static mrb_value drb_ffi_ice_fs_rename_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_rename': wrong number of arguments (%d for 2)", argc);
    char *path1_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
    char *path2_1 = drb_ffi__ZTSPc_FromRuby(state, args[1]);
...
static mrb_value drb_ffi_ice_fs_is_empty_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_is_empty': wrong number of arguments (%d for 1)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
static mrb_value drb_ffi_ice_fs_get_date_Binding(mrb_state *state, mrb_value value) {
    ...
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'ice_fs_get_date': wrong number of arguments (%d for 3)", argc);
    char *path_0 = drb_ffi__ZTSPc_FromRuby(state, args[0]);
...
void drb_register_c_extensions_with_api(mrb_state *state, struct drb_api_t *api) {
    ...
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_len", drb_ffi_ice_fs_str_len_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_starts_with_slash", drb_ffi_ice_fs_str_starts_with_slash_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_ends_with_slash", drb_ffi_ice_fs_str_ends_with_slash_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_slashes", drb_ffi_ice_fs_str_slashes_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_dots", drb_ffi_ice_fs_str_dots_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_same", drb_ffi_ice_fs_str_same_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_char_to_str", drb_ffi_ice_fs_str_char_to_str_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_sub", drb_ffi_ice_fs_str_sub_Binding, MRB_ARGS_REQ(3));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_copy", drb_ffi_ice_fs_str_copy_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_split", drb_ffi_ice_fs_str_split_Binding, MRB_ARGS_REQ(3));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_splitlines", drb_ffi_ice_fs_str_splitlines_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_str_matches", drb_ffi_ice_fs_str_matches_Binding, MRB_ARGS_REQ(3));
    drb_api->mrb_define_module_function(state, module, "ice_fs_free_str", drb_ffi_ice_fs_free_str_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_free_strarr", drb_ffi_ice_fs_free_strarr_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_root", drb_ffi_ice_fs_root_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_is_root", drb_ffi_ice_fs_is_root_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_concat_path", drb_ffi_ice_fs_concat_path_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_filename", drb_ffi_ice_fs_filename_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_ext", drb_ffi_ice_fs_ext_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_is_ext", drb_ffi_ice_fs_is_ext_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_prev_path", drb_ffi_ice_fs_prev_path_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_path_parents", drb_ffi_ice_fs_path_parents_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_path_exists", drb_ffi_ice_fs_path_exists_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_cwd", drb_ffi_ice_fs_cwd_Binding, MRB_ARGS_REQ(0));
    drb_api->mrb_define_module_function(state, module, "ice_fs_home", drb_ffi_ice_fs_home_Binding, MRB_ARGS_REQ(0));
    drb_api->mrb_define_module_function(state, module, "ice_fs_format_path", drb_ffi_ice_fs_format_path_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_fullpath", drb_ffi_ice_fs_fullpath_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_link", drb_ffi_ice_fs_link_Binding, MRB_ARGS_REQ(3));
    drb_api->mrb_define_module_function(state, module, "ice_fs_readlink", drb_ffi_ice_fs_readlink_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_type", drb_ffi_ice_fs_type_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_file_content", drb_ffi_ice_fs_file_content_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_file_write", drb_ffi_ice_fs_file_write_Binding, MRB_ARGS_REQ(3));
    drb_api->mrb_define_module_function(state, module, "ice_fs_file_lines", drb_ffi_ice_fs_file_lines_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_chdir", drb_ffi_ice_fs_chdir_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_dir_content", drb_ffi_ice_fs_dir_content_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_free_dir_content", drb_ffi_ice_fs_free_dir_content_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_dir_search", drb_ffi_ice_fs_dir_search_Binding, MRB_ARGS_REQ(3));
    drb_api->mrb_define_module_function(state, module, "ice_fs_create", drb_ffi_ice_fs_create_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_remove", drb_ffi_ice_fs_remove_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_clear", drb_ffi_ice_fs_clear_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_copy", drb_ffi_ice_fs_copy_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_move", drb_ffi_ice_fs_move_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_rename", drb_ffi_ice_fs_rename_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "ice_fs_is_empty", drb_ffi_ice_fs_is_empty_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "ice_fs_get_date", drb_ffi_ice_fs_get_date_Binding, MRB_ARGS_REQ(3));
    ...
    struct RClass *ice_fs_dir_ptr_class = drb_api->mrb_define_class_under(state, module, "ICE_FS_DIR_PTR", object_class);
    drb_api->mrb_define_class_method(state, ice_fs_dir_ptr_class, "new", drb_ffi__ZTSP10ice_fs_dir_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_dir_ptr_class, "value", drb_ffi__ZTSP10ice_fs_dir_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_dir_ptr_class, "[]", drb_ffi__ZTSP10ice_fs_dir_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_dir_ptr_class, "[]=", drb_ffi__ZTSP10ice_fs_dir_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, ice_fs_dir_ptr_class, "nil?", drb_ffi__ZTSP10ice_fs_dir_IsNil, MRB_ARGS_REQ(0));
    struct RClass *ice_fs_date_ptr_class = drb_api->mrb_define_class_under(state, module, "ICE_FS_DATE_PTR", object_class);
    drb_api->mrb_define_class_method(state, ice_fs_date_ptr_class, "new", drb_ffi__ZTSP11ice_fs_date_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_ptr_class, "value", drb_ffi__ZTSP11ice_fs_date_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_ptr_class, "[]", drb_ffi__ZTSP11ice_fs_date_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_ptr_class, "[]=", drb_ffi__ZTSP11ice_fs_date_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, ice_fs_date_ptr_class, "nil?", drb_ffi__ZTSP11ice_fs_date_IsNil, MRB_ARGS_REQ(0));
    struct RClass *ice_fs_object_ptr_class = drb_api->mrb_define_class_under(state, module, "ICE_FS_OBJECT_PTR", object_class);
    drb_api->mrb_define_class_method(state, ice_fs_object_ptr_class, "new", drb_ffi__ZTSP13ice_fs_object_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_object_ptr_class, "value", drb_ffi__ZTSP13ice_fs_object_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_object_ptr_class, "[]", drb_ffi__ZTSP13ice_fs_object_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_object_ptr_class, "[]=", drb_ffi__ZTSP13ice_fs_object_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, ice_fs_object_ptr_class, "nil?", drb_ffi__ZTSP13ice_fs_object_IsNil, MRB_ARGS_REQ(0));
    struct RClass *ice_fs_dir_class = drb_api->mrb_define_class_under(state, module, "ICE_FS_DIR", object_class);
    drb_api->mrb_define_class_method(state, ice_fs_dir_class, "new", drb_ffi__ZTS10ice_fs_dir_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_dir_class, "items", drb_ffi__ZTS10ice_fs_dir_items_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_dir_class, "items=", drb_ffi__ZTS10ice_fs_dir_items_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_dir_class, "items_count", drb_ffi__ZTS10ice_fs_dir_items_count_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_dir_class, "items_count=", drb_ffi__ZTS10ice_fs_dir_items_count_Set, MRB_ARGS_REQ(1));
    struct RClass *ice_fs_date_class = drb_api->mrb_define_class_under(state, module, "ICE_FS_DATE", object_class);
    drb_api->mrb_define_class_method(state, ice_fs_date_class, "new", drb_ffi__ZTS11ice_fs_date_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "str", drb_ffi__ZTS11ice_fs_date_str_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "str=", drb_ffi__ZTS11ice_fs_date_str_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "epoch", drb_ffi__ZTS11ice_fs_date_epoch_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "epoch=", drb_ffi__ZTS11ice_fs_date_epoch_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "seconds", drb_ffi__ZTS11ice_fs_date_seconds_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "seconds=", drb_ffi__ZTS11ice_fs_date_seconds_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "minutes", drb_ffi__ZTS11ice_fs_date_minutes_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "minutes=", drb_ffi__ZTS11ice_fs_date_minutes_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "hour", drb_ffi__ZTS11ice_fs_date_hour_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "hour=", drb_ffi__ZTS11ice_fs_date_hour_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "week_day", drb_ffi__ZTS11ice_fs_date_week_day_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "week_day=", drb_ffi__ZTS11ice_fs_date_week_day_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "month_day", drb_ffi__ZTS11ice_fs_date_month_day_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "month_day=", drb_ffi__ZTS11ice_fs_date_month_day_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "year_day", drb_ffi__ZTS11ice_fs_date_year_day_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "year_day=", drb_ffi__ZTS11ice_fs_date_year_day_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "month", drb_ffi__ZTS11ice_fs_date_month_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "month=", drb_ffi__ZTS11ice_fs_date_month_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "season", drb_ffi__ZTS11ice_fs_date_season_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "season=", drb_ffi__ZTS11ice_fs_date_season_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_date_class, "year", drb_ffi__ZTS11ice_fs_date_year_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_date_class, "year=", drb_ffi__ZTS11ice_fs_date_year_Set, MRB_ARGS_REQ(1));
    struct RClass *ice_fs_object_class = drb_api->mrb_define_class_under(state, module, "ICE_FS_OBJECT", object_class);
    drb_api->mrb_define_class_method(state, ice_fs_object_class, "new", drb_ffi__ZTS13ice_fs_object_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_object_class, "name", drb_ffi__ZTS13ice_fs_object_name_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_object_class, "name=", drb_ffi__ZTS13ice_fs_object_name_Set, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, ice_fs_object_class, "type", drb_ffi__ZTS13ice_fs_object_type_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, ice_fs_object_class, "type=", drb_ffi__ZTS13ice_fs_object_type_Set, MRB_ARGS_REQ(1));
}
